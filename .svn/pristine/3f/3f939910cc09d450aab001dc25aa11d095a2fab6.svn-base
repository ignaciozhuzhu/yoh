				...
				<div className="bmargin1">
					<div>
						<div className="btn-group pull-right " role="group" aria-label="...">
							<button type="button" className="btn btn-primary resbg-color no-border" id="cancelResBtn" onClick={this.cancelRes}>取消挂号</button>
						</div>
						<div className="page-title">挂号详情</div>
					</div>
					<div className="row">
...
ReactDOM.render(
	<PatientBox data={reservationList} />,
